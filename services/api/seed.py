...
# Validar con el modelo Pydantic y convertir a JSON
validated_suppliers = [
    Suppliers(**item).model_dump(mode="json")
    for item in SUPPLIERS_SEED
]

# Limpiar la tabla de proveedores antes de insertar los datos semilla para evitar duplicados
